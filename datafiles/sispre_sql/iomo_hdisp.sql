...
-------------------------------------------------
-- IPU (Antigo IP-CUC) Horas Disponíveis
-------------------------------------------------
select
	p.dataFechamento, sum(a.qtdHoraMin)/60.0 total_IPCUC_HDISP_@@MESNUM@@_@@ANONUM@@
from 
...
where
	...
	and ativ.codigo not in (34, 35, 36, 37)
...
-------------------------------------------------
-- IPS + IPC (Antigo 'IPF todo') Horas Disponíveis
-------------------------------------------------
select
	p.dataFechamento, sum(a.qtdHoraMin)/60.0 total_IPSIPCCM_HDISP_@@MESNUM@@_@@ANONUM@@
from 
	PeriodoApropriacao p,
	Empregado e,
	Apropriacao a,
...
-------------------------------------------------
-- IQ Horas Disponíveis
-------------------------------------------------
select
	p.dataFechamento, sum(a.qtdHoraMin)/60.0 total_IQ_HDISP_@@MESNUM@@_@@ANONUM@@
from 
	PeriodoApropriacao p,
	Empregado e,
	Apropriacao a,
...
-------------------------------------------------
select
	sum(a.qtdHoraMin)/60.0 TOTAL_HORAS_DISPONIVEIS_@@MESNUM@@_@@ANONUM@@
from 
	PeriodoApropriacao p,
	Empregado e,
	Apropriacao a,
